...
This notebook creates some additional figures appearing in Kemp, Category systems across languages reflect a preference for symmetry.
...
# now deprecated -- so this notebook no longer actually saves the figure
