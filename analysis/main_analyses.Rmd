...
Plots and analyses for Kemp, Even or Odd? Symmetry and the size of category systems across languages. Running this entire notebook takes a couple of hours -- in particular the regression analyses for kinship are relatively slow.
...
The table for `all_results_bayes` shows warnings for one domain (parent's siblings) but I haven't addressed this since these results aren't included in the paper.
