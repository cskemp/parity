...
Plots and analyses for Kemp, Even or Odd? Symmetry and the size of category systems across languages. Running this entire notebook takes around two hours -- in particular the regression analyses for kinship are relatively slow.
...
run_phylo <- function(dstats, domainname) {
  ...
  # Calculate covariance matrix. We follow Guzmán Naranjo and Becker and set corr = TRUE, 
