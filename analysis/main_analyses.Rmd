...
Plots and analyses for Kemp, Category systems across languages show a preference for symmetry. Running this entire notebook takes around two hours -- in particular the regression analyses for kinship are relatively slow.
